import { _decorator, Component, Slider, Label, Node, Vec4, UIRenderer, dynamicAtlasManager, find, Material } from 'cc';
const { ccclass, property } = _decorator;

@ccclass('GlowOutter')
export default class GlowOutter extends Component {
    ...
    private _examplesParentNode: Node | null = null;
    ...
    onLoad() {
        ...
        this._examplesParentNode = find("Canvas/Content/Examples");
    }
    ...
    private _onSliderChanged() {
        ...
        this._updateRenderComponentMaterial({
            glowColor: new Vec4(this._redSlider.progress, this._greenSlider.progress, this._blueSlider.progress, this._alphaSlider.progress),
