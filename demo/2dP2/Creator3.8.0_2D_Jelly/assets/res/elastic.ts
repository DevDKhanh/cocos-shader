...
import { _decorator, Component, Node, Material, Sprite, PhysicsSystem2D, EPhysics2DDrawFlags, UITransform, v4, Vec3, v3, EventTouch, Vec2, v2, Input, SystemEventType } from 'cc';
...
export class Elastic extends Component {
    ...
    start() {
        ...
        // [3]
        this.mat = this.node.getComponent(Sprite)?.getSharedMaterial(0)!;
